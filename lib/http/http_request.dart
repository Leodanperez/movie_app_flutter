...
import 'package:movie_app/models/movie/movie_details_model.dart';
...
import 'package:movie_app/models/tv/tv_details_model.dart';
import 'package:movie_app/models/tv/tv_model.dart';

class HttpRequest {
  static final String? apiKey = dotenv.env['API_KEY'];
  static const String language = "es-pe";
  ...
  static Future<MovieModel> getMovies(String request) async {
    ...
    try {
      ...
      return MovieModel.withError("Ocurrio un error: $error");
    }
  }
